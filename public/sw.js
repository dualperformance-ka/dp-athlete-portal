const CACHE_NAME = 'dp-athlete-v205'; // v205: one due slot with fixed precedence, floating action button removed
const APP_SHELL = [
  '/index.html', '/styles.css?v=162', '/desktop.css?v=10', '/config.js',
