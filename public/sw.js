const CACHE_NAME = 'dp-athlete-v146'; // v146: five primary tabs with Check-in kept visible through More and Home
const APP_SHELL = [
  '/index.html', '/styles.css?v=116', '/desktop.css?v=5', '/config.js',
